...
Ninit_GP = 12
lhd = DR1.StandardNormal_Indep(N=Ninit_GP) # DR1.TrisoRandom(N=Ninit_GP) #  DR1.TrisoLHS(Nsamps=Ninit_GP) #  uniform(loc=-3.5,scale=7.0).ppf(lhd0) #
inp_GPtrain = lhd
...
for ii in np.arange(0,Nsub,1):
    inp = DR1.StandardNormal_Indep() # inp = DR1.TrisoRandom()
