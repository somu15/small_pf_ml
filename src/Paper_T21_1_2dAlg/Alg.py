...
Ninit_GP = 20
lhd, lhd2 = DR1.TrisoRandom(Nsamps=Ninit_GP) #  uniform(loc=-3.5,scale=7.0).ppf(lhd0) #
inp_LFtrain = lhd
...
Ninit_GP = 20
lhd, lhd0 = DR1.TrisoRandom(Nsamps=Ninit_GP)
inp_GPtrain = lhd
...
counter = 1
file1 = open('/home/dhullaks/projects/Small_Pf_code/src/Paper_T21_1_Alg/Results_retrain.csv','w')
...
for ii in np.arange(0,Nsub,1):
    ...
    if u_check > u_lim:
        ...
        subs_info[ii,0] = 1.0
    file1 = open('/home/dhullaks/projects/Small_Pf_code/src/Paper_T21_1_Alg/Results_retrain.csv','r')
...
os.chdir('/home/dhullaks/projects/Small_Pf_code/src/Paper_T21_1_Alg')
