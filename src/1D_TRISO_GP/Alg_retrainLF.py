...
amp0, len0 = ML0.GP_train(amp_init=1., len_init=1., num_iters = 5000)
...
amp1, len1 = ML.GP_train(amp_init=1., len_init=1., num_iters = 5000)
Iters = 2000
...
counter = 1
file1 = open('/home/dhullaks/projects/Small_Pf_code/src/1D_TRISO_GP/Results_retrain.csv','w')
...
for ii in np.arange(0,Nsub,1):
    ...
    if u_check > u_lim:
        ...
        subs_info[ii,0] = 1.0
    file1 = open('/home/dhullaks/projects/Small_Pf_code/src/1D_TRISO_GP/Results_retrain.csv','r')
