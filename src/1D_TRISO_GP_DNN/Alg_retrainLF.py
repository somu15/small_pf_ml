...
inp_GPtrain = lhd
y_LF_GP = ML0.DNN_pred(P,DNN_model,Ndim,inp_GPtrain)[0]
...
for ii in np.arange(0,Nsub,1):
    ...
    LF = ML0.DNN_pred(P,DNN_model,Ndim,inpp)[0]
    inp1[ii,:,0] = inp
    ...
    if u_check > u_lim:
        ...
        y_LF_GP = ML0.DNN_pred(P,DNN_model,Ndim,inp_GPtrain).reshape(len(y_HF_GP))
        y_GPtrain = y_HF_GP - y_LF_GP
